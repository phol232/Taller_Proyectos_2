"use client";
// RF-01: Gestión CRUD de Estudiantes — Fase 1
...
export default function StudentsPage() {
  ...
  return (
    <PageShell
      title={t.subpages.students.title}
      description={t.subpages.students.desc}
    >
      <Card className="flex flex-col items-center justify-center py-16 bg-white border border-gray-100 shadow-none rounded-xl">
        ...
        <p className="text-xs text-gray-400">{t.subpages.students.phase}</p>
      </Card>
    </PageShell>
  );
}
